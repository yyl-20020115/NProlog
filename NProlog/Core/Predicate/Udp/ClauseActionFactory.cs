...
public class ClauseActionFactory
{
    ...
    public static ClauseAction CreateClauseAction(KnowledgeBase kb, ClauseModel model)
    {
        ...
        foreach (Term t in consequent.Args)
        {
    ...
    public class AlwaysMatchedFact : ClauseAction
    {
        ...
        public AlwaysMatchedFact(ClauseModel model)
        {
            this.model = model;
        }
    ...
    public class ZeroArgConsequentRule : ClauseAction
    {
        ...
        public ZeroArgConsequentRule(ClauseModel model, PredicateFactory pf)
        {
            this.model = model;
            this.pf = pf;
        }
        ...
        {
            var antecedent = model.Antecedent;
            return antecedent.IsImmutable ? pf.GetPredicate(antecedent.Args) : pf.GetPredicate(TermUtils.Copy(antecedent.Args));
        }
        ...
        public bool IsAlwaysCutOnBacktrack => pf.IsAlwaysCutOnBacktrack;
    }
    ...
    public class ImmutableFact : ClauseAction
    {
        ...
        public ImmutableFact(ClauseModel model)
        {
            this.model = model;
        }
    ...
    public class ImmutableConsequentRule : ClauseAction
    {
        ...
        public ImmutableConsequentRule(ClauseModel model, PredicateFactory pf)
        {
            this.model = model;
            this.pf = pf;
        }
    ...
    public class MutableFact : ClauseAction
    {
        ...
        public MutableFact(ClauseModel model)
        {
            this.model = model;
        }
    ...
    public class MutableRule : ClauseAction
    {
        ...
        public MutableRule(ClauseModel model, PredicateFactory pf)
        {
            this.model = model;
            this.pf = pf;
        }
        ...
        public Predicate GetPredicate(Term[] input)
        {
            ...
            {
                return pf.GetPredicate(antecedent.Args);
            }
            else
            {
