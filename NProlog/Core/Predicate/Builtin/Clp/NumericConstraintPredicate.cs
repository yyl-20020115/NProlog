 ...
 * </ul>
 */
public class NumericConstraintPredicate : AbstractSingleResultPredicate , ConstraintFactory {
   ...
   private readonly BiFunction<Expression, Expression, Constraint> constraintGenerator;
   ...
   protected override bool Evaluate(Term x, Term y) {
   ...
   protected void init() {
      expressions = KnowledgeBaseServiceLocator.GetServiceLocator(KnowledgeBase).GetInstance(
