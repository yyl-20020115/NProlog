...
% (Note: Prolog provides a built-in is_list(X) predicate.)
...
% (Note: Prolog provides built-in member(X,Y) and memberchk(X,Y) predicates.)
...
% Appending two lists.
% (Note: Prolog provides a built-in Append(X,Y,Z) predicate.)
...
% (Note: Prolog provides a built-in reverse(X,Y) predicate.)
...
% (Note: Prolog provides a built-in last(X,Y) predicate.)
...
% (Note: Prolog provides a built-in Length(X,Y) predicate.)
...
% (Note: Prolog provides a built-in delete(X,Y,Z) predicate.)
...
% (Note: Prolog provides a built-in select(X,Y,Z) predicate.)
