...
%?- meta_data(p(_), X)
% X=factory_class : org.prolog.core.predicate.UnknownPredicate
% X=factory_isRetryable : true
% X=factory_isAlwaysCutOnBacktrack : false
% X=processed_class : org.prolog.core.predicate.UnknownPredicate
...
%?- meta_data(p(_), X)
% X=factory_class : org.prolog.core.predicate.udp.DynamicUserDefinedPredicateFactory
% X=factory_isRetryable : true
% X=factory_isAlwaysCutOnBacktrack : false
